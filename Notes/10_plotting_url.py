...
ghg_index = header.index("Total GHG Emissions (Metrix Tons CO2e)")
...
colors = ["green" x for x in valid_data]
for i in range(37):
    colors[i] = "red"


plt.figure("GHG School Plot", tight_layout=True)

plt.scatter(ghg, sqft, alpha=0.3, c=colors)  # s for size and c for color
